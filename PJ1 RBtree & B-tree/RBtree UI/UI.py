...
class Gui():
    def __init__(self, window):
        ...
        self.updateButton = Button(self.window, text="update", width=8, command=self.update)
        self.searchButton = Button(self.window, text="search", width=8, command=self.search)
        self.dumpButton = Button(self.window, text="dump", width=8, command=self.dump)
